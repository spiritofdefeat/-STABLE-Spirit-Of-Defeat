...
static const float WATER_COLOR_LIGHTNESS = 0.15;
static const float WATER_RIPPLE_EFFECT = 0.0025;

static const float COLORMAP_OVERLAY_STRENGTH 	= 0.95f; //0.7f;
...
static const float GB_CAM_MIN = 20.0f;
static const float GB_CAM_MAX = 100.0f;
...
static const float BORDER_FOW_REMOVAL_FACTOR = .9f; // How much of the FOW that is removed from the borders. 1.0f is no FOW
...
static const float GB_STRENGTH_CH2 = 0.1; // Opacity of top layer
